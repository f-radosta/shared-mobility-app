...
import { AcceptRideForm } from "@/components/rides/accept-ride-form";

export default async function AcceptRidePage({
  params,
}: {
  params: { id: string };
}) {
  ...
  // Check if the ride is in a state that can be accepted
    ...
    <div className="container mx-auto py-8">
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          <h1 className="text-2xl font-bold">Accept Ride Request</h1>
          <p className="text-gray-500 mt-2">
            You are about to accept a ride request. Please review the details below.
          </p>
        </div>
