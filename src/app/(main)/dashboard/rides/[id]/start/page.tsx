...
import { ArrowLeft, PlayCircle, User, MapPin, Calendar, Clock } from "lucide-react";
import { StartRideForm } from "@/components/rides/start-ride-form";
...
export default async function StartRidePage({
  ...
  // Check if the ride is in a state that can be started
    ...
    <div className="container mx-auto py-8">
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          <h1 className="text-2xl font-bold">Start Ride</h1>
          <p className="text-gray-500 mt-2">
            You are about to start the ride. This will notify the passenger that you are on your way.
          </p>
        </div>
