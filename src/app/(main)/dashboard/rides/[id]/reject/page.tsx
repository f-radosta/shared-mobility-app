...
import { ArrowLeft, XCircle, User, MapPin, Calendar, Clock } from "lucide-react";
import { RejectRideForm } from "@/components/rides/reject-ride-form";

export default async function RejectRidePage({
  params,
}: {
  params: { id: string };
}) {
  ...
  // Check if the ride is in a state that can be rejected
    ...
    <div className="container mx-auto py-8">
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          <h1 className="text-2xl font-bold">Reject Ride Request</h1>
          <p className="text-gray-500 mt-2">
            You are about to reject a ride request. Please provide a reason for the rejection.
          </p>
        </div>
